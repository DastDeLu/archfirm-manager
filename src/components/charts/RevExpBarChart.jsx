        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-lg">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between gap-4">
              <span className="text-sm text-emerald-600">Ricavi:</span>
              <span className="text-sm font-medium">{formatCurrency(revenue)}</span>
            </div>
            <div className="flex items-center justify-between gap-4">
              <span className="text-sm text-red-600">Costi:</span>
              <span className="text-sm font-medium">{formatCurrency(expense)}</span>
            </div>
            <div className="flex items-center justify-between gap-4 pt-1 border-t border-slate-200">
              <span className="text-sm font-semibold text-slate-700">Netto:</span>
